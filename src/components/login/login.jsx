...
//     switch (name) {
//       case "email":
//         if (!value) setErrors((err) => ({ ...err, email: "Email cannot be empty" }));
//         else setErrors((err) => ({ ...err, email: "" }));
//         setUser((u) => ({ ...u, Email: value }));
//         break;

//       case "password":
//         if (!value) setErrors((err) => ({ ...err, password: "Password cannot be empty" }));
//         else setErrors((err) => ({ ...err, password: "" }));
...
//         // Show popup for Customer trying to access admin
//         alert("❌ Customers are not allowed to access the Admin Dashboard.");
//         sessionStorage.clear(); // Clear session
//         setMessage("❌ You cannot access the admin panel as a Customer.");
//       } else {
